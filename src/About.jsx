...
function About() {
  ...
  <div className="education w-full max-h-10 px-10 border-b-2 hover:max-h-[200px] hover:bg-white hover:text-black transition-all duration-300 overflow-hidden hover:rounded-lg hover:py-5">
    ...
    <p>I am currently pursuing a B.Tech in Electronics and VLSI Engineering from IIIT Delhi and completed my schooling at Kulachi Hansraj Model School, laying the foundation for my passion for cutting-edge technology and innovation.</p>
  </div>
  ...
  <div className="tech w-full max-h-10 px-10 border-b-2 hover:max-h-[250px] hover:bg-white hover:text-black transition-all duration-300 overflow-hidden hover:rounded-lg hover:py-5">
    ...
    <p>I am proficient in a wide range of technologies, including Python, C++, Java, HTML, Vanilla CSS, JavaScript, React.js, Tailwind CSS, OpenCV, MySQL, Firebase, Pygame, Matplotlib, MATLAB, JavaFX, Folium, Verilog, and DSA. Additionally, I am skilled in using tools like Figma, Canva, IntelliJ, Vivado, KiCad, and LTSpice, reflecting my versatility in both software development and hardware design.</p>
  </div>
  ...
  <div className="hobbies w-full max-h-10 px-10 border-b-2 hover:max-h-[200px] hover:bg-white hover:text-black transition-all duration-300 overflow-hidden hover:rounded-lg hover:py-5">
    ...
    <p>My hobbies include playing cricket, reading books, engaging in strategic games like chess, playing the guitar, singing a bit, and enjoying music.</p>
  </div>
</div>
