    ...
    >
      <div className="container w-9/12 flex items-center justify-between gap-48 mx-auto">
        ...
        <img
          src={pfp}
          alt="Profile Picture"
          className="w-[28.875rem] h-auto"
        />
      </div>

      {/* Hover Wrapper */}
      <div className="absolute left-[12rem] bottom-12 flex items-center justify-center group">
        {/* Circle scales and fills white on hover */}
        <div
          className="scrollclick h-28 w-28 rounded-full border-2 border-white bg-transparent group-hover:bg-white group-hover:scale-50 transition-all duration-500 ease-in-out flex items-center justify-center"
        >
          {/* Down Arrow */}
          <svg
